...
pub(crate) fn list_overdue_milestones(
...
mod tests {
    ...
    use crate::{
        output::DummyOutput,
        tasks::overdue_milestones::list_overdue_milestones,
        vcs_service::{
    ...
    #[test]
    fn check_overdue_milestones_empty() {
        ...
        list_overdue_milestones(&vcs_service_mock, at, "Release", &mut output).unwrap();
