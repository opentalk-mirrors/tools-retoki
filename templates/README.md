...
{% for serie in series %}
    section {{ serie.version }}{% if show_release_series_codenames %} {{ serie.codename }}{% endif %}
...
## {{ serie.version }}{% if show_release_series_codenames and serie.codename %} ({{ serie.codename }}){% endif %}
